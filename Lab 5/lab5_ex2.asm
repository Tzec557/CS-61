...
CHECK
    ...
    NOT R3 R1   
    ADD R3 R3 #1    ;negative number of r1 address which it is the starting address of array
    ...
    ADD R0 R7 R5    ;check if the negative of first array value add the last array value is np, 
    ...
    ADD R0 R3 R2    ;check when will the array end(add the negative of start array address with r2
                    ;since r2 will decreament to the start array addres, then we know when should we stop)
    BRZP CHECK
